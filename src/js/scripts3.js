...
// Create Layered Surface Texture (Different Colors for Layers)
...
// Apply the layered texture exactly on the cut plane
const cutSurfaceGeometry = new THREE.CircleGeometry(1, 64);
const cutSurface = new THREE.Mesh(cutSurfaceGeometry, layerMaterial);
cutSurface.rotation.y = Math.PI / 2;  // Align with cut plane
cutSurface.position.x = 0;  // **FIXED**: Ensuring perfect alignment
scene.add(cutSurface);

// Add Stronger Point Light to highlight layers
